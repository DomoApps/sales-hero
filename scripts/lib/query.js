...
/***/ function(module, exports, __webpack_require__) {
	...
	function lazy(_x) {
	  ...
	  _function: while (_again) {
	    ...
	    // if passed a function, recursively evaluate it.
	...
	var Filter = (function () {
	  ...
	  Filter.prototype.lt = function lt(value) {
	    this._expressionArray = [this._columnName, ' < ', function () {
	      return quote(value);
	    }];
	    return this._context;
	  };
	  ...
	  Filter.prototype.contains = function contains(value) {
	    this._expressionArray = [this._columnName, ' contains ', function () {
	      return quote(value);
	    }];
	    return this._context;
	  };
	  ...
	  Filter.prototype['in'] = function _in(args) {
	    ...
	    this._expressionArray = [this._columnName, ' in ', '[', function () {
	      return quote(arr);
	    }, ']'];
	    return this._context;
	  };
